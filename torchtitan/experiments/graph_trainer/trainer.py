...
class GraphTrainer(Trainer):
    ...
    def _select_fwd_bwd_fn(
        ...
        self._validate_deferred_fsdp_gradient_sync()
    ...
    def _validate_deferred_fsdp_gradient_sync(self) -> None:
        ...
        if self.parallel_dims.pp_enabled:
            raise ValueError(
                "--compile.enable_deferred_fsdp_gradient_sync currently supports "
                "only one-stage GraphPipelineRuntime execution"
            )
